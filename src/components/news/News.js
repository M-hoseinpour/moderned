...
function News() {
    return (
        <div className='news'>
            ...
            <News_item description="Agricultural engineers attempt to solve agricultural problems concerning power supplies, the efficiency of machinery, the use of structures and facilities, pollution and environmental issues, and the storage and processing of agricultural products" title='What Is an Agricultural Engineer ?' img='https://www.thebalancecareers.com/thmb/-POjGmtLtUCJK_dY_CxhYffGIV0=/400x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-154319842-4c12c21d1a9f4e079a7db4fc125f39cf.jpg' />
            <News_item description="The average Manager salary in the United States is $150,448 as of June 28, 2021. The range for our most popular Manager positions (listed below) typically falls between $99,004 and $201,893" title='Find out What the Highest Paying Management Jobs Are' img='https://www.thebalancecareers.com/thmb/w10EKdW_hn6L9fRG01NrYOHXZr0=/400x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/143382528-56a0f0e83df78cafdaa69beb.jpg' />
        </div>
    )
}
